...
writer = SummaryWriter('Q8_trainloss')
...
# -------------------- 8. Training Loop with TensorBoard SummaryWriter--------------------
...
for epoch in range(1, epochs + 1):
    ...
    avg_loss_per_token = epoch_loss / total_tokens
    print(f'Epoch {epoch}/{epochs}, Loss per token: {avg_loss_per_token:.6f}')
...
print(f'Validation Loss per token: {val_loss:.6f}')
